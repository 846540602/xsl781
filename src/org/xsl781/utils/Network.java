...
public class Network {
	...
	public static boolean printNetworkInfo(Context context) {
		...
		if (connectivity != null) {
			...
			android.util.Log.i(TAG, "getActiveNetworkInfo: " + in);
			NetworkInfo[] info = connectivity.getAllNetworkInfo();
			if (info != null) {
				for (int i = 0; i < info.length; i++) {
					// if (info[i].getType() == ConnectivityManager.TYPE_WIFI) {
					android.util.Log.i(TAG, "NetworkInfo[" + i + "]isAvailable : " + info[i].isAvailable());
					android.util.Log.i(TAG, "NetworkInfo[" + i + "]isConnected : " + info[i].isConnected());
					android.util.Log.i(TAG, "NetworkInfo[" + i + "]isConnectedOrConnecting : " + info[i].isConnectedOrConnecting());
					android.util.Log.i(TAG, "NetworkInfo[" + i + "]: " + info[i]);
					// }
				}
				android.util.Log.i(TAG, "\n");
			} else {
				android.util.Log.i(TAG, "getAllNetworkInfo is null");
			}
		}
		return false;
	}
