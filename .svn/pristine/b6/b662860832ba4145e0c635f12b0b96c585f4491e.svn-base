...
public class XListViewHeader extends LinearLayout {
	...
	private void initView(Context context) {
		...
		container = (LinearLayout) LayoutInflater.from(context).inflate(
				XslResource.getIdByName(context, "layout", "xsl781_xlistview_header"), null);
		addView(container, lp);
		// 初始化控件
		mArrowImageView = (ImageView) findViewById(XslResource.getIdByName(context, "id",
				"xlistview_header_arrow"));
		mHintTextView = (TextView) findViewById(XslResource.getIdByName(context, "id",
				"xlistview_header_hint_textview"));
		mLastUpdateTime = (TextView) findViewById(XslResource.getIdByName(context, "id",
				"xlistview_header_time"));
		headTimeLL = (ViewGroup) findViewById(XslResource.getIdByName(context, "id",
				"xlistview_header_time_ll"));

		mProgressBar = (ProgressBar) findViewById(XslResource.getIdByName(context, "id",
	...
	public void setState(int state) {
		...
		case STATE_NORMAL:
			...
			mHintTextView.setText(XslResource.getIdByName(ctx, "string",
					"xlistview_header_hint_normal"));
			break;
		case STATE_READY:
			if (mState != STATE_READY) {
				mArrowImageView.clearAnimation();
				...
				mHintTextView.setText(XslResource.getIdByName(ctx, "string",
						"xlistview_header_hint_ready"));
			}
			break;
		case STATE_REFRESHING:
			mHintTextView.setText(XslResource.getIdByName(ctx, "string",
					"xlistview_header_hint_loading"));
			break;
		default:
		}
